...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_KTW");
    reader.add_event(60, 60, "end", "model_KTW");
    return reader;
}

class model_KTW : public prob_grad {
private:
    int nData;
    int nSpecies;
    vector<int> nFaeces;
...
public:
    model_KTW(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_KTW_namespace::model_KTW";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
        ...
        num_params_r__ += nSpecies;
        validate_non_negative_index("n", "nSpecies", nSpecies);
        num_params_r__ += nSpecies;
        ++num_params_r__;
    }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("n")))
            throw std::runtime_error("variable n missing");
        vals_r__ = context__.vals_r("n");
        pos__ = 0U;
        validate_non_negative_index("n", "nSpecies", nSpecies);
        context__.validate_dims("initialization", "n", "double", context__.to_vec(nSpecies));
        // generate_declaration n
        std::vector<double> n(nSpecies,double(0));
        for (int i0__ = 0U; i0__ < nSpecies; ++i0__)
            n[i0__] = vals_r__[pos__++];
        for (int i0__ = 0U; i0__ < nSpecies; ++i0__)
            try {
            writer__.scalar_lb_unconstrain(0,n[i0__]);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable n: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        vector<T__> n;
        size_t dim_n_0__ = nSpecies;
        n.reserve(dim_n_0__);
        for (size_t k_0__ = 0; k_0__ < dim_n_0__; ++k_0__) {
            if (jacobian__)
        ...
        stan::math::initialize(phi, DUMMY_VAR__);
        stan::math::fill(phi,DUMMY_VAR__);
        validate_non_negative_index("prop", "nData", nData);
        validate_non_negative_index("prop", "nSpecies", nSpecies);
        Eigen::Matrix<T__,Eigen::Dynamic,Eigen::Dynamic>  prop(static_cast<Eigen::VectorXd::Index>(nData),static_cast<Eigen::VectorXd::Index>(nSpecies));
        (void) prop;  // dummy to suppress unused var warning

        stan::math::initialize(prop, DUMMY_VAR__);
        stan::math::fill(prop,DUMMY_VAR__);
        validate_non_negative_index("theta", "nData", nData);
        validate_non_negative_index("theta", "nSpecies", nSpecies);
        Eigen::Matrix<T__,Eigen::Dynamic,Eigen::Dynamic>  theta(static_cast<Eigen::VectorXd::Index>(nData),static_cast<Eigen::VectorXd::Index>(nSpecies));
        (void) theta;  // dummy to suppress unused var warning

        stan::math::initialize(theta, DUMMY_VAR__);
        stan::math::fill(theta,DUMMY_VAR__);
        validate_non_negative_index("N_avail_exp", "nData", nData);
        validate_non_negative_index("N_avail_exp", "nSpecies", nSpecies);
        Eigen::Matrix<T__,Eigen::Dynamic,Eigen::Dynamic>  N_avail_exp(static_cast<Eigen::VectorXd::Index>(nData),static_cast<Eigen::VectorXd::Index>(nSpecies));
        (void) N_avail_exp;  // dummy to suppress unused var warning

        stan::math::initialize(N_avail_exp, DUMMY_VAR__);
        stan::math::fill(N_avail_exp,DUMMY_VAR__);
        ...
        try {
            for (int i = 1; i <= nData; ++i) {
                ...
                for (int j = 1; j <= nSpecies; ++j) {
                    ...
                    stan::math::assign(get_base1_lhs(N_avail_exp,i,j,"N_avail_exp",1), pow(get_base1(N_avail,i,j,"N_avail",1),get_base1(m,j,"m",1)));
                }
                for (int j = 1; j <= nSpecies; ++j) {

                    stan::math::assign(get_base1_lhs(prop,i,j,"prop",1), ((get_base1(a,j,"a",1) * get_base1(N_avail_exp,i,j,"N_avail_exp",1)) / sum(elt_multiply(elt_multiply(a,h),get_base1(N_avail_exp,i,"N_avail_exp",1)))));
                    stan::math::assign(get_base1_lhs(theta,i,j,"theta",1), (pow(sum(elt_multiply(elt_multiply(a,h),get_base1(N_avail,i,"N_avail",1))),get_base1(n,j,"n",1)) / (1 + pow(sum(elt_multiply(elt_multiply(a,h),get_base1(N_avail,i,"N_avail",1))),get_base1(n,j,"n",1)))));
                    stan::math::assign(get_base1_lhs(phi,i,j,"phi",1), (get_base1(prop,i,j,"prop",1) * get_base1(theta,i,j,"theta",1)));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        ...
        for (int i0__ = 0; i0__ < nData; ++i0__) {
            for (int i1__ = 0; i1__ < nSpecies; ++i1__) {
                if (stan::math::is_uninitialized(prop(i0__,i1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: prop" << '[' << i0__ << ']' << '[' << i1__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
        }
        ...
        for (int i0__ = 0; i0__ < nData; ++i0__) {
            for (int i1__ = 0; i1__ < nSpecies; ++i1__) {
                if (stan::math::is_uninitialized(N_avail_exp(i0__,i1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: N_avail_exp" << '[' << i0__ << ']' << '[' << i1__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
        }
        ...
        check_greater_or_equal(function__,"prop",prop,0);
        check_less_or_equal(function__,"prop",prop,1);
        ...
        try {
            ...
            lp_accum__.add(uniform_log<propto__>(n, 0, 10));
            for (int i = 1; i <= nData; ++i) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_KTW_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        ...
        validate_non_negative_index("prop", "nData", nData);
        validate_non_negative_index("prop", "nSpecies", nSpecies);
        matrix_d prop(static_cast<Eigen::VectorXd::Index>(nData),static_cast<Eigen::VectorXd::Index>(nSpecies));
        (void) prop;  // dummy to suppress unused var warning
        ...
        validate_non_negative_index("theta", "nData", nData);
        validate_non_negative_index("theta", "nSpecies", nSpecies);
        matrix_d theta(static_cast<Eigen::VectorXd::Index>(nData),static_cast<Eigen::VectorXd::Index>(nSpecies));
        (void) theta;  // dummy to suppress unused var warning
        ...
        validate_non_negative_index("N_avail_exp", "nData", nData);
        validate_non_negative_index("N_avail_exp", "nSpecies", nSpecies);
        matrix_d N_avail_exp(static_cast<Eigen::VectorXd::Index>(nData),static_cast<Eigen::VectorXd::Index>(nSpecies));
        (void) N_avail_exp;  // dummy to suppress unused var warning

        stan::math::initialize(N_avail_exp, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(N_avail_exp,DUMMY_VAR__);
        ...
        for (int k_1__ = 0; k_1__ < nSpecies; ++k_1__) {
            for (int k_0__ = 0; k_0__ < nData; ++k_0__) {
                vars__.push_back(prop(k_0__, k_1__));
            }
        }
        for (int k_1__ = 0; k_1__ < nSpecies; ++k_1__) {
            for (int k_0__ = 0; k_0__ < nData; ++k_0__) {
        ...
        for (int k_1__ = 0; k_1__ < nSpecies; ++k_1__) {
            for (int k_0__ = 0; k_0__ < nData; ++k_0__) {
                vars__.push_back(N_avail_exp(k_0__, k_1__));
            }
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_1__ = 1; k_1__ <= nSpecies; ++k_1__) {
            for (int k_0__ = 1; k_0__ <= nData; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "prop" << '.' << k_0__ << '.' << k_1__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        for (int k_1__ = 1; k_1__ <= nSpecies; ++k_1__) {
        ...
        for (int k_1__ = 1; k_1__ <= nSpecies; ++k_1__) {
            for (int k_0__ = 1; k_0__ <= nData; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "N_avail_exp" << '.' << k_0__ << '.' << k_1__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        ...
        try {
            for (int i = 1; i <= nData; ++i) {
                ...
                for (int j = 1; j <= nSpecies; ++j) {
                    ...
                    stan::math::assign(get_base1_lhs(phi,i,j,"phi",1), ((get_base1(a,j,"a",1) * get_base1(N_avail_exp,i,j,"N_avail_exp",1)) / (1 + sum(elt_multiply(elt_multiply(a,h),get_base1(N_avail_exp,i,"N_avail_exp",1))))));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
